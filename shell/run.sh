...
#Run Producer: After exporting it as a runnable jar, run the followings (it is assumed that the jar file is exported to Desktop folder):
cd ~/Desktop
...
#Run the Consumer program finally
